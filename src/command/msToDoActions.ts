...
export class MsTodoActions {
    ...
    public async syncVault() {
        ...
        // Show informative sync completion message
        const syncMessage = t('CommandNotice_SyncComplete', {
            pluginName: t('PluginTitle'),
            updated: updatedTasks,
        });
        this.userNotice.showMessage(syncMessage, 4000);
    }
